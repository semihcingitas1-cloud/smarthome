...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Otomasyon', path: '/user/automations', icon: <Zap size={25} /> },
    { name: 'Sesli Komut', path: '/user/aivoiceconfig', icon: <Mic2 size={25} /> },
    { name: 'Mekan Yönetimi', path: '/user/spacemanager', icon: <School size={25} /> },
  ];
  ...
  return (
    ...
    <div className="z-50">
      ...
      <div className="hidden lg:flex flex-col min-w-[280px] bg-white dark:bg-slate-900 text-gray-900 dark:text-white sticky top-16 border-r border-gray-200 dark:border-slate-800 shadow-lg dark:shadow-none transition-colors duration-300">

        <div className="py-6 px-6 border-b border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900">

          <div className="flex items-center gap-3">

            <div className="bg-blue-600 p-2 rounded-xl shadow-lg shadow-blue-600/30"><HomeIcon className="text-white" size={24} /></div>
            ...
            <div>
              ...
              <span className="text-gray-500 dark:text-slate-500 text-[10px] uppercase font-bold tracking-widest">Yönetim Paneli</span>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-900 border-t border-gray-200 dark:border-slate-800 z-50 flex items-center h-20 shadow-[0_-10px_30px_rgba(0,0,0,0.1)] dark:shadow-[0_-10px_30px_rgba(0,0,0,0.5)] transition-colors duration-300">
        ...
        <div onClick={logout} className="flex flex-col items-center justify-center w-20 h-full bg-gray-50 dark:bg-slate-950 border-l border-gray-200 dark:border-slate-800 text-red-500 active:bg-red-50 dark:active:bg-red-500/10 transition-colors">
