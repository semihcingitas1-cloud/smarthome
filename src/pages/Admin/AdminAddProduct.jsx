        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => setPreviewMode(!previewMode)} className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-xl transition-colors">
                <Eye size={18} />
                Önizle
              </button>

              <button onClick={duplicateProduct} className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-xl transition-colors">
                <Copy size={18} />
                Kopyala
              </button>

              <button onClick={() => handleSave(true)} disabled={isSaving} className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-xl transition-colors disabled:opacity-50">
                Taslak Kaydet
              </button>
              ...
              {activeTab === 'basic' && ( <div className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className={`flex-1 bg-slate-950 border rounded-xl px-4 py-3 focus:outline-none transition-colors ${
                            errors.sku ? 'border-red-500' : 'border-slate-800 focus:border-blue-500'
                          }`}
                        />
                        <button
                          onClick={generateSKU}
                          className="px-4 bg-slate-800 hover:bg-slate-700 rounded-xl transition-colors"
                          title="SKU Oluştur"
                        >
                          <Zap size={18} />
                        </button>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <select
                          ...
                          className={`w-full bg-slate-950 border rounded-xl px-4 py-3 focus:outline-none transition-colors appearance-none ${
                            errors.category ? 'border-red-500' : 'border-slate-800 focus:border-blue-500'
                          }`}
                        >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 transition-colors appearance-none disabled:opacity-50"
                        >
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      rows="3"
                      placeholder="Ürünün kısa özeti (Liste görünümünde gösterilir)"
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full bg-slate-950 border rounded-xl pl-4 pr-12 py-3 focus:outline-none transition-colors ${
                            errors.price ? 'border-red-500' : 'border-slate-800 focus:border-blue-500'
                          }`}
                        />
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-4 pr-12 py-3 focus:outline-none focus:border-blue-500 transition-colors"
                        />
                        <span className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500">₺</span>
                      </div>
                      {formData.price && formData.oldPrice && (
                        <p className="text-xs text-green-400">
                          %{Math.round(((formData.oldPrice - formData.price) / formData.oldPrice) * 100)} İndirim
                        </p>
                      )}
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full bg-slate-950 border rounded-xl px-4 py-3 focus:outline-none transition-colors ${
                          errors.stock ? 'border-red-500' : 'border-slate-800 focus:border-blue-500'
                        }`}
                      />
                      {errors.stock && (
                        <p className="text-red-400 text-xs flex items-center gap-1">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      {badges.map((badge) => (
                        <button
                          key={badge.value}
                          onClick={() => handleChange('badge', formData.badge === badge.value ? '' : badge.value)}
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center gap-3 cursor-pointer group">
                      <input
                        ...
                        className="w-5 h-5 rounded border-slate-700 bg-slate-950 text-blue-600 focus:ring-2 focus:ring-blue-500"
                      />
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      {formData.features.map((feature, index) => (
                        <div key={index} className="flex gap-2">
                          <input
                            type="text"
                            placeholder="Örn: WiFi 2.4GHz & 5GHz Desteği"
                            value={feature}
                            onChange={(e) => updateFeature(index, e.target.value)}
                            className="flex-1 bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 transition-colors"
                          />
                          <button
                    ...
                    <div className="space-y-3">
                      {formData.specifications.map((spec, index) => (
                        <div key={index} className="flex gap-2">
                          <input
                            type="text"
                            placeholder="Özellik (örn: Güç Tüketimi)"
                            value={spec.key}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-2">
                      <input
                        type="text"
                        placeholder="Etiket ekle (örn: akıllı, LED, enerji)"
                        value={tagInput}
                      ...
                      <button
                        onClick={addTag}
                        className="px-6 bg-blue-600 hover:bg-blue-700 rounded-xl transition-colors"
                      >
                        <Plus size={18} />
                      </button>
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        onClick={addModel}
                        className="flex items-center gap-2 px-3 py-1 bg-orange-600 hover:bg-orange-700 rounded-lg text-sm transition-colors"
                      >
                        <Plus size={16} />
                        Model Ekle
                      </button>
                    ...
                    <div className="space-y-4">
                      {formData.models.map((model, index) => (
                        <div key={index} className="bg-slate-950 border border-slate-800 rounded-2xl p-6 space-y-4">
                          <div className="flex items-center justify-between">
                          ...
                          <div className="grid md:grid-cols-3 gap-4">
                            <input
                              type="text"
                              placeholder="Model Adı (örn: Pro)"
                              value={model.name}
                              onChange={(e) => updateModel(index, 'name', e.target.value)}
                              className="bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 transition-colors"
                            />
                            <input
                              type="number"
                              placeholder="Fiyat"
                            ...
                            <input
                              ...
                              placeholder="Stok"
                              value={model.stock}
                              onChange={(e) => updateModel(index, 'stock', e.target.value)}
                              className="bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 transition-colors"
                            />
                          </div>
                        </div>
                  ...
                  {formData.images.length > 0 && (
                    <div>
                      <div className="flex items-center justify-between mb-4">
                        <p className="text-sm text-slate-400">
                          {formData.images.length} görsel yüklendi
                        </p>
                        <p className="text-xs text-slate-500">
                          İlk görsel ana görsel olarak kullanılacak
                        </p>
                      </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-400">Arama motoru optimizasyonu</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-500/5 border border-blue-500/20 rounded-xl p-4 flex items-start gap-3">
                    ...
                    <div className="text-sm text-slate-300">
                      ...
                      <p className="text-slate-400">
                        Başlık ve açıklama alanlarını boş bırakırsanız, ürün adı ve kısa açıklama otomatik kullanılır.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      type="text"
                      placeholder="Ürün için SEO başlığı"
                      value={formData.seoTitle}
                      onChange={(e) => handleChange('seoTitle', e.target.value)}
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 transition-colors"
                    />
                    <p className="text-xs text-slate-500">{formData.seoTitle.length} / 60 karakter</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 transition-colors resize-none"
                    />
                    <p className="text-xs text-slate-500">{formData.seoDescription.length} / 160 karakter</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      type="text"
                      placeholder="akıllı led, panel, aydınlatma (virgülle ayırın)"
                  ...
                  <div className="bg-slate-950 border border-slate-800 rounded-2xl p-6">
                    <h4 className="font-semibold mb-4 text-sm text-slate-400">Arama Motoru Önizlemesi</h4>
                    <div className="space-y-2">
                      <h3 className="text-blue-400 text-lg hover:underline cursor-pointer">
                        {formData.seoTitle || formData.name || 'Ürün Başlığı'}
                      </h3>
                      <p className="text-green-600 text-sm">
                        smarthome.com › urunler › {formData.sku || 'sku'}
                      </p>
